...
if (OPTION_USE_WAYLAND AND NOT OPTION_USE_SYSTEM_LIBDECOR)
  ...
  if (GTK_FOUND)
    ...
    find_library(HAVE_LIB_GTK gtk-3 ${CMAKE_LIBRARY_PATH})
    find_library(HAVE_LIB_GDK gdk-3 ${CMAKE_LIBRARY_PATH})
    find_library(HAVE_LIB_GLIB glib-2.0 ${CMAKE_LIBRARY_PATH})
    find_library(HAVE_LIB_GIO gio-2.0 ${CMAKE_LIBRARY_PATH})
  endif (GTK_FOUND)
